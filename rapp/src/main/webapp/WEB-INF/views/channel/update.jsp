	                    ...
	                    <div class="ibox-content">
	                        <div class="row">
	                            <div class="col-sm-8 b-r">
	                                <!-- form左边 -->
	                                <form id="updateChannelForm" class="form-horizontal" action="${rapp.rootPath }channel/updateChannel" method="post" autocomplete="off">
										<div class="col-md-12">
...
<!-- 										    </div> -->
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$('#updateChannelForm').bootstrapValidator({
