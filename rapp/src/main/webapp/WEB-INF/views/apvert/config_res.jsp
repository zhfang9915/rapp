	                    ...
	                    <div class="ibox-content">
	                        <div class="row">
	                            <div class="col-sm-8 b-r">
	                                <!-- form左边 -->
											<div class="col-md-12">
												<form id="configAdvertForm" class="form-horizontal" action="${rapp.rootPath }apvert/config/res/submit/${advert.advertId }" 
													method="post" autocomplete="off">
												    <div id="advertRes">
												    	<div class="col-sm-11 res-1">
												    		<div class="form-group">
														    	<label class="col-sm-2 control-label">资源1：</label>
														        <div class="col-sm-10">
														            <div class="input-group">
									                                    <span class="input-group-btn">
									                                        <button type="button" class="btn btn-info" onclick="advert.openUploadModal(1);">
									                                            	本地上传
									                                        </button>
									                                    </span>
									                                    <input type="text" id="advertUrl1" name="advertUrl" class="form-control" placeholder="必填:请输入广告图片或视频链接" onclick="advert.removeErrorClass('advertUrl1');">
									                                </div>
														    ...
														    <div class="form-group">
														        ...
														        <div class="col-sm-10">
														            <input type="text" id="toUrl1" name="toUrl" class="form-control" placeholder="选填:请输入广告点击后跳转的链接"> 
														            <span class="help-block m-b-none"></span>
														        </div>
														        
														    </div>
												    	</div>
												    	<div class="col-sm-1 res-1 text-center">
												    		<c:if test="${advert.temp.isMore eq 'Y' }">
													    		<button type="button" class="btn btn-default btn-sm" onclick="advert.removeAdvertRes('1');" style="margin-top: 30px;">
												    ...
												    <div class="form-group">
												        ...
												        <div class="col-sm-9">
												            ...
												            <button class="btn btn-primary" type="button" onclick="advert.submitConfig();">确认，创建广告</button>
												        </div>
