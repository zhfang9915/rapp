...
<html lang="zh-CN">
<head>
<title>${channel.channelNameCh }绑定设备</title>
<meta charset="utf-8">
...
<body>
	...
	<div class="container">
		<div class="wrapper wrapper-content animated fadeInRight minheight">
			<div class="ibox-title">
				<div class="col-md-6"><h3>${channel.channelNameCh }可绑定的设备</h3></div>
				<div class="col-md-6 ibox-tools text-right">
	                <a href="${rootPath }router/binding/${channel.channelId}" class="btn btn-primary">已有设备</a>
	            </div>
	        </div>
			<div class="ibox-content" id="no-router" style="display:none;">
	             <div class="text-center p-lg">
	                 <h2>${channel.channelNameCh } 渠道没有可绑定的设备</h2>
	                 <span>您可以</span>
	                 <a class="btn btn-primary" href="${rapp.taobao }" target="_blank">
	        ...
	        <div class="ibox-title" id="binding-edit" style="display:none;">
	            ...
	            <div class="col-md-6 text-right" style="right:-30px;">
	                <button class="btn btn-primary" id="bindingSubmit">保存绑定</button>
	            </div>
	        </div>
	        <br/>
	...
	<script type="text/javascript" src="${rapp.nginx }script/router/binding.router.js"></script>
