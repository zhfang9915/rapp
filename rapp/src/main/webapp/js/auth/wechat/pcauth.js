var QRCode; (function() {
    ...
    l.prototype = {
        ...
        write: function(a) {
            for (var d = 0,
            b = this.parsedData.length; d < b; d++) a.put(this.parsedData[d], 8)
        }
    };
    f.prototype = {
        addData: function(a) {
        ...
        mapData: function(a, d) {
            ...
            e = 7,
            g = 0,
            q = this.moduleCount - 1; 0 < q; q -= 2) for (6 == q && q--;;) {
    ...
    f.createBytes = function(a, d) {
        ...
        c = 0,
        e = 0,
        g = Array(d.length), q = Array(d.length), h = 0; h < d.length; h++) {
            var u = d[h].dataCount,
            f = d[h].totalCount - u,
            c = Math.max(c, u),
            e = Math.max(e, f);
            ...
            for (n = 0; n < q[h].length; n++) f = n + u.getLength() - q[h].length,
            q[h][n] = 0 <= f ? u.get(f) : 0
        }
        for (n = h = 0; n < d.length; n++) h += d[n].totalCount;
        b = Array(h);
        for (n = u = 0; n < c; n++) for (h = 0; h < d.length; h++) n < g[h].length && (b[u++] = g[h][n]);
        for (n = 0; n < e; n++) for (h = 0; h < d.length; h++) n < q[h].length && (b[u++] = q[h][n]);
        return b
    };
    for (var t = {
        MODE_NUMBER: 1,
    ...
    m = {
        ...
        getLostPoint: function(a) {
            for (var d = a.getModuleCount(), b = 0, c = 0; c < d; c++) for (var e = 0; e < d; e++) {
                for (var g = 0,
                q = a.isDark(c, e), h = -1; 1 >= h; h++) if (! (0 > c + h || d <= c + h)) for (var f = -1; 1 >= f; f++) 0 > e + f || d <= e + f || 0 == h && 0 == f || q != a.isDark(c + h, e + f) || g++;
                5 < g && (b += 3 + g - 5)
            }
            ...
            for (e = g = 0; e < d; e++) for (c = 0; c < d; c++) a.isDark(c, e) && g++;
            return b += Math.abs(100 * g / d / d - 50) / 5 * 10,
            b
        }
    },
    p = {
    ...
    v.getRSBlocks = function(a, d) {
        ...
        for (var c = b.length / 3,
        e = [], g = 0; g < c; g++) for (var f = b[3 * g + 0], h = b[3 * g + 1], u = b[3 * g + 2], k = 0; k < f; k++) e.push(new v(h, u));
        return e
    };
    ...
    A = "svg" === document.documentElement.tagName.toLowerCase() ? r: "undefined" == typeof CanvasRenderingContext2D ?
    function() {
        var a = function(a, b) {
            this._el = a;
            this._htOption = b
        ...
        a.prototype.draw = function(a) {
            ...
            c = this._el,
            e = a.getModuleCount(), g = Math.floor(b.width / e), f = Math.floor(b.height / e), h = ['<table style="border:0;border-collapse:collapse;">'], k = 0; k < e; k++) {
                h.push("<tr>");
        ...
        if (this._android && 2.1 >= this._android) {
            ...
            CanvasRenderingContext2D.prototype.drawImage = function(a, d, e, f, k, n, l, m, r) {
                if ("nodeName" in a && /img/i.test(a.nodeName)) for (var p = arguments.length - 1; 1 <= p; p--) arguments[p] *= b;
...
var jsonpId = 1E4; (function() {
    JSAPI = {
        ...
        genHashCode: function(l) {
            for (var f = 0,
            k = 0; k < l.length; k++) if (f = 31 * f + l.charCodeAt(k), 2147483647 < f || -2147483648 > f) f &= 4294967295;
            return 0 <= f ? f: -f
        },
        ...
        queryState: function(l) {
            ...
            30001));
            this.jsonp("https://wifi.weixin.qq.com/cgi-bin/pollpcresult?ticket=" + l,
            function(k) {
        ...
        gotoAuth: function(l) { - 1 != this.opt.authUrl.indexOf("?") ? window.location = this.opt.authUrl + "&" + l + "&extend=" + encodeURIComponent(this.opt.extend) : window.location = this.opt.authUrl + "?" + l + "&extend=" + encodeURIComponent(this.opt.extend)
        },
        jsonp: function(l, f) {
            jsonpId++;
